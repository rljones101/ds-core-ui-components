<template>
  <div class="nav">
    ...
    <router-link to="/ds-button">
      DsButton
    </router-link>
    <router-link to="/ds-card">
      DsCard
    </router-link>
    <router-link to="/ds-advanced-select">
      DsAdvancedSelect
    </router-link>
    <router-link to="/ds-pagination">
      DsPagination
    </router-link>
    <router-link to="/ds-breadcrumbs">
      DsBreadcrumbs
    </router-link>
    <router-link to="/ds-datepicker">
      DsDatepicker
    </router-link>
